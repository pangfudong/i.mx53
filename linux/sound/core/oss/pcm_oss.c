...
static const char proc_filename[] = "driver/wm8711";
...
static int wm8711_proc_read(char *page, char **start, off_t off, int count, int *eof, void *_dev)
{
    int ret = 0;
    ...
    ret = snprintf(page, count, "is playing: %d\n", is_playing);
    *eof = 1;
    return ret;
}
...
static int __init alsa_pcm_oss_init(void)
{
	...
	if (NULL == create_proc_read_entry(proc_filename, 0, NULL, wm8711_proc_read, NULL))
	{
