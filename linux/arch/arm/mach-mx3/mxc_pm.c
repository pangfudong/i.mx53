...
/*!
 * Restore AIPS regs. Those regs are reset after resume.
 */
static void restore_aips_regs(void)
{
	__raw_writel(0x77777777, IO_ADDRESS(AIPS2_BASE_ADDR + 0x0));
	__raw_writel(0x77777777, IO_ADDRESS(AIPS2_BASE_ADDR + 0x4));
	__raw_writel(0x50000000, IO_ADDRESS(AIPS2_BASE_ADDR + 0x20));
	__raw_writel(0x0, IO_ADDRESS(AIPS2_BASE_ADDR + 0x24));
	__raw_writel(0x0, IO_ADDRESS(AIPS2_BASE_ADDR + 0x28));
	__raw_writel(0x0, IO_ADDRESS(AIPS2_BASE_ADDR + 0x2C));
	...
	__raw_writel(0x0, IO_ADDRESS(AIPS2_BASE_ADDR + 0x50));
}
...
void mxc_pm_lowpower(int mode)
{
	...
	case DSM_MODE:
		...
		/* wake up by keypad, power key and usbotg */
