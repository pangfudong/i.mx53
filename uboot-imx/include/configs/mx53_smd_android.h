...
#define CONFIG_ANDROID_RECOVERY_BOOTARGS_MMC \
	"setenv bootargs ${bootargs} init=/init root=/dev/mmcblk0p4 rootfs=ext4 video=mxcdi0fb:RGB24,1080P60 ldb=di0 di0_primary"
...
#define	CONFIG_EXTRA_ENV_SETTINGS					\
		...
		"bootargs_android=setenv bootargs ${bootargs} " \
		     "androidboot.console=ttymxc0 init=/init hdmi "\
		     "video=mxcdi0fb:RGB24,1080P60 ldb=di0 di0_primary gpu_memory=64M\0"   \
